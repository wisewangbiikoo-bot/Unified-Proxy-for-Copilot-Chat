...
技术基础：[DeepSeek V4 for Copilot Chat v0.5.2](https://github.com/Vizards/deepseek-v4-for-copilot)（MIT）。Provider ID 为 `unified-proxy`，可与官方 DeepSeek V4 扩展（`deepseek`）**同时安装、互不覆盖**。
