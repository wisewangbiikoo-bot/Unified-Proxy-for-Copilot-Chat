...
**如何搜到本仓库？** 在 **About → Topics** 粘贴空格分隔的一行（**整行 ≤约200 字符**，见 [docs/GITHUB_TOPICS_SETUP.zh-cn.md](./docs/GITHUB_TOPICS_SETUP.zh-cn.md) 或 [repository-topics-manual.txt](./.github/repository-topics-manual.txt)）。
